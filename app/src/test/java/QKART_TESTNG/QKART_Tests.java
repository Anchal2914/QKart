...
public class QKART_Tests extends DP {
     ...
     */
    @Test(description = "Verify registration happens correctly", priority = 1, groups = { "Sanity_test" }, dataProvider = "data-provider"
    )
    ...
    public void TestCase01(String TC1_Username, String TC1_Password)
        ...
        System.out.println(TC1_Password);
