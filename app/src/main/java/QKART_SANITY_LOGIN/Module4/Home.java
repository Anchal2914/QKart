...
public class Home {
    ...
    public Boolean searchForProduct(String product) {
        try {
            ...
            WebDriverWait wait = new WebDriverWait(driver,30);
            wait.until(ExpectedConditions.or(ExpectedConditions.presenceOfElementLocated(By.xpath("//*[contains(@class, 'css-uickyz')]")),
    ...
    public Boolean isNoResultFound() {
        ...
        try {
            ...
            status = driver.findElementByXPath("//*[contains(text(), ' No products found ')]").isDisplayed();
            return status;
        } catch (Exception e) {
            return status;
        }
    ...
    public Boolean verifyCartContents(List<String> expectedCartContents) {
        try {
            ...
            // WebElement cartParent = driver.findElement(By.xpath("//div[contains(@class,'cart')]"));
            // List<WebElement> cartContents = cartParent.findElements(By.xpath("//*[@class='MuiBox-root css-1gjj37g']/div[1]"));

            // ArrayList<String> actualCartContents = new ArrayList<String>() {
            // };
            // for (WebElement cartItem : cartContents) {
            //     actualCartContents.add(cartItem.findElement(By.xpath("//*[contains(@class, 'css-1gjj37g')]")).getText().split("\n")[0]);
            // }
