    ...
    public Boolean verifyInsufficientBalanceMessage() {
        try {
            ...
            WebElement insufficientBalanceElement = driver.findElement(By.xpath("//div[@class=\"SnackbarItem-wrappedRoot css-vbcata\"]/div"));
                ...
                if(insufficientBalanceElement.isDisplayed()==true) {

                    if(insufficientBalanceElement.getText().equalsIgnoreCase("You do not have enough balance in your wallet for this purchase")){
                        isDisplayed=true;
                    }
                }
            return isDisplayed;
