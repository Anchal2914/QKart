...
public class QKART_Tests {
     ...
     */
        ...
        @Parameters({"TC2_Username" , "TC2_Username"})
        public void TestCase02 (@Optional("testUser")String TC2_Username, @Optional("abc@123")String TC2_Password) throws InterruptedException {
            ...
            assertFalse(status, "Failed to registered existing user");
        }
    /*
     ...
     */
        ...
        public void TestCase03(String TC3_ProductNameToSearchFor1, String TC3_ProductNameToSearchFor2) throws InterruptedException {
            ...
            status = homePage.searchForProduct(TC3_ProductNameToSearchFor1);
            ...
            assertTrue(searchResults.size() == 0, "Results were available");    
            assertTrue(homePage.isNoResultFound(), "No products found message is displayed");
        }

    /*
     * Testcase04: Verify the presence of size chart and check if the size chart content is as
     * expected
     */
        ...
        public void TestCase04(@Optional("Roadster")String TC4_ProductNameToSearchFor) throws InterruptedException {
            ...
            for (WebElement webElement : searchResults) {
                ...
                assertFalse(homePage.isNoResultFound(), "Size Chart Link does not exist");            
                ...
                assertTrue(result.validateSizeChartContents(expectedTableHeaders,
                    expectedTableBody, driver), "Failure while validating contents of Size Chart Link"); 
    ...
    /* 
     * Testcase05: Verify the complete flow of checking out and placing order for products is working correctly
    */
     ...
     */
        ...
        public void TestCase06(String TC6_ProductNameToSearch1, String TC6_ProductNameToSearch2) throws InterruptedException {
            ...
            homePage.navigateToHome();
            homePage.PerformLogout();
            assertTrue(status, "Cart can not be edited"); 
        }
     ...
     */
        ...
        @Parameters({"TC7_ProductsToAddToCart1","TC7_ProductsToAddToCart2"})
        public void TestCase07(String TC7_ProductsToAddToCart1, String TC7_ProductsToAddToCart2) throws InterruptedException {
            Boolean status = false;
            List<String> expectedResult =
                    Arrays.asList(TC7_ProductsToAddToCart1, TC7_ProductsToAddToCart2);
            ...
            homePage.addProductToCart(TC7_ProductsToAddToCart1);

            status = homePage.searchForProduct("Xtend");
            homePage.addProductToCart(TC7_ProductsToAddToCart2);
    ...
    /*
     * Testcase08: Verify that insufficient balance error is thrown
     */   
    ...
    /*
     * Testcase09: Verify product added to a cart is available when a new tab is added
     */    
        @Test(dependsOnMethods = "TestCase10", priority = 10, description = "Verify that a product added to a cart is available when a new tab is added", groups = "Regression_Test")
    ...
    /*
     * Testcase10: Verify that privacy policy and about us links are working fine
     */   
    ...
    /*
     * Testcase11: Verify that the contact us dialog works fine
     */ 
    ...
    /*
     * Testcase12: Ensure Advertisement Links on the QKART page are clickable
     */ 
        ...
        public void TestCase12(String TC12_ProductNameToSearch, String TC12_AddresstoAdd) throws InterruptedException {
            ...
            assertTrue(status, "Verify that 3 Advertisements are not available");
            ...
            assertTrue(status, "Verify that Advertisement 1 is not clickable");
            ...
            status = !driver.getCurrentUrl().equals(currentURL);
            assertTrue(status, "Verify that Advertisement 2 is not clickable");
        }
